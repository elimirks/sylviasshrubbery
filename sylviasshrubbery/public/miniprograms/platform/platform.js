...
Player.prototype.update = function(game) {
    ...
    var newVelocityX = Math.max(Math.min(newVelocityX, this.terminalX), -this.terminalX);
    var newVelocityY = Math.max(Math.min(newVelocityY, this.terminalY), -this.terminalY);
