---
title: Switching from Arch to Debian
description: Switching from Arch to Debian
pubDate: "Nov 09 2015"
...
One thing I will _really_ miss about Arch is yaourt - a package manager which connects with the Arch User Repository. Basically any package you could think of would be contained in there. As an alternative, I installed Linuxbrew. It doesn't seem to have as many packages, but I am really digging how the formulae are easily modifiable in ruby! (expect to see a linuxbrew-formulae repository in my Github soon...).
